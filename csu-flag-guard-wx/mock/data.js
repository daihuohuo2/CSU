...
var tutorials = [
  {
    id: 'tu001', title: '立正', category: '基础动作重点', createdBy: 'admin',
  ...
  {
    id: 'tu002', title: '正步走', category: '基础动作重点', createdBy: 'admin',
  ...
  {
    id: 'tu003', title: '升旗流程', category: '基础动作重点', createdBy: 'admin',
  ...
  {
    id: 'tu004', title: '敬礼与礼毕', category: '基础动作重点', createdBy: 'admin',
    content: '举手礼是标准敬礼方式。\n\n动作要领：\n1. 上体正直，右手取捷径迅速抬起\n2. 五指并拢，手掌摆平\n3. 中指微接帽檐右角前约2厘米处\n4. 手腕不得弯曲，大臂略平\n5. 同时注视受礼者\n\n礼毕：将手放下，取捷径，成立正姿势',
    tips: '1. 动作干脆有力\n2. 手掌角度要正确\n3. 目光坚定注视前方',
  ...
  {
    id: 'tu005', title: '齐步走', category: '基础动作重点', createdBy: 'admin',
  ...
  {
    id: 'tu006', title: '降旗流程', category: '基础动作重点', createdBy: 'admin',
